    ...
    <div className={`tabsContainer mt-0 `}>
      ...
      >
        <Tab eventKey="home" title="Home">
          ...
          turpis et quam congue nisl accumsan. The top three occupations in the
          Beauty salons Industry Group are Hairdressers, hairstylists, &
          cosmetologists, Manicurists and pedicurists, Receptionists &
          information clerks, Supervisors of personal care and service workers,
